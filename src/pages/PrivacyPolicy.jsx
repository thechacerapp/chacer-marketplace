      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 md:p-12">
          ...
          <Section title="7. Your Rights & Choices">
            ...
            <p className="mt-3">To exercise any of these rights, contact us at <a href="mailto:support@thechacer.com" className="text-blue-600 underline">support@thechacer.com</a>.</p>
          </Section>
          ...
          <Section title="11. Contact Us">
            ...
            <div className="mt-3 bg-gray-50 rounded-xl p-4 border border-gray-100">
              ...
              <p className="text-gray-600">Email: <a href="mailto:support@thechacer.com" className="text-blue-600 underline">support@thechacer.com</a></p>
