    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {/* Monthly */}
          <div className="rounded-2xl p-8 bg-white border border-gray-200 shadow-sm flex flex-col">
            ...
            <Link to={`${createPageUrl("GetStartedPage")}?plan=Monthly&billing=monthly`} className="mb-8">
          ...
          {/* Annual */}
          <div className="rounded-2xl p-8 bg-blue-900 text-white shadow-2xl ring-2 ring-blue-400 flex flex-col">
            ...
            <Link to={`${createPageUrl("GetStartedPage")}?plan=Annual&billing=annual`} className="mb-8">
